              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <span className="text-[9px] font-bold text-slate-500 uppercase">Maxilla</span>
                    <select 
                      value={treatmentPlan.typeOfAppliance.maxilla || ''}
                      onChange={(e) => handleUpdatePlan('typeOfAppliance.maxilla', e.target.value)}
                  ...
                  <div className="space-y-2">
                    <span className="text-[9px] font-bold text-slate-500 uppercase">Mandible</span>
                    <select 
                      value={treatmentPlan.typeOfAppliance.mandible || ''}
                      onChange={(e) => handleUpdatePlan('typeOfAppliance.mandible', e.target.value)}
                      className="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 bg-slate-50 outline-none focus:ring-2 focus:ring-blue-500/20"
                    >
                      <option value="fixed">Fixed</option>
                      <option value="removable">Removable</option>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <span className="text-[9px] font-bold text-slate-500 uppercase">Maxilla</span>
                    <select 
                      value={treatmentPlan.anchorageRequirements.maxilla || ''}
                      onChange={(e) => handleUpdatePlan('anchorageRequirements.maxilla', e.target.value)}
                  ...
                  <div className="space-y-2">
                    <span className="text-[9px] font-bold text-slate-500 uppercase">Mandible</span>
                    <select 
                      value={treatmentPlan.anchorageRequirements.mandible || ''}
                      onChange={(e) => handleUpdatePlan('anchorageRequirements.mandible', e.target.value)}
                      className="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 bg-slate-50 outline-none focus:ring-2 focus:ring-purple-500/20"
                    >
                      <option value="minimum">Minimum</option>
                      <option value="moderate">Moderate</option>
          ...
          <div className="bg-white rounded-[32px] p-6 border border-slate-200 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <span className="text-[9px] font-bold text-slate-500 uppercase">Maxilla</span>
                <select 
                  value={treatmentPlan.retention.maxilla || ''}
                  onChange={(e) => handleUpdatePlan('retention.maxilla', e.target.value)}
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 bg-slate-50 outline-none focus:ring-2 focus:ring-blue-500/20"
                >
                  <option value="fixed">Fixed</option>
              ...
              <div className="space-y-2">
                <span className="text-[9px] font-bold text-slate-500 uppercase">Mandible</span>
                <select 
                  value={treatmentPlan.retention.mandible || ''}
                  onChange={(e) => handleUpdatePlan('retention.mandible', e.target.value)}
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 bg-slate-50 outline-none focus:ring-2 focus:ring-blue-500/20"
                >
                  <option value="fixed">Fixed</option>
                  <option value="essix">Essix</option>
