...
export const ActionPanel: React.FC<ActionPanelProps> = ({ onSaveSnapshot }) => {
  const { 
    actions, 
    notes, 
    attachments, 
  ...
  return (
    <aside className="w-60 border-r border-slate-200 bg-white flex flex-col h-full shadow-sm">
      {/* Header */}
