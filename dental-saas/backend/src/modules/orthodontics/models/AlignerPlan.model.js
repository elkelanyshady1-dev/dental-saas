...
const movementSchema = new mongoose.Schema(
    {
        ...
        translation: {
            mesialDistal: { type: Number, default: 0 },
            buccoLingual: { type: Number, default: 0 },
            intrusion: { type: Number, default: 0 },
            extrusion: { type: Number, default: 0 }
        },
        // Rotational movements in degrees
        rotation: {
            torque: { type: Number, default: 0 },
            tipMesialDistal: { type: Number, default: 0 },
            rotationBuccoLingual: { type: Number, default: 0 }
        }
    },
    { _id: false }
);
...
const stageSchema = new mongoose.Schema(
    {
        ...
        attachments: [{
            fdiNumber: { type: Number },
            type: { type: String, enum: ["conventional", "optimized", "power_ridge", "beveled"] },
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, alignerPlanSchema),
};
