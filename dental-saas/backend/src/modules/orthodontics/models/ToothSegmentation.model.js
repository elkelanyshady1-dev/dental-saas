...
const toothLabelSchema = new mongoose.Schema(
    {
        ...
        mesiodistalWidth: { type: Number },
        buccolingualWidth: { type: Number }
    },
    { _id: false }
);
...
const toothSegmentationSchema = new mongoose.Schema(
    {
        ...
        boltonAnalysis: {
            anteriorRatio: { type: Number },
            overallRatio: { type: Number },
            anteriorExcess: { type: Number },
            overallExcess: { type: Number }
        },
        // Status
        status: {
            type: String,
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, toothSegmentationSchema),
};
