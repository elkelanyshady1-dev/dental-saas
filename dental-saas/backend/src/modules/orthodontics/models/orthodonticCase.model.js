...
const photoRecordSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ["ceph", "intraoral", "extraoral", "panoramic", "occlusal", "xray"],
    default: "intraoral"
  },
  url: {
    type: String,
...
const problemSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ["skeletal", "dental", "soft-tissue", "functional", "esthetic"],
    default: "dental"
  },
  title: {
    type: String,
...
const treatmentOptionSchema = new mongoose.Schema({
  ...
  approach: {
    type: String,
    enum: ["conservative", "moderate", "aggressive", "surgical", "custom"],
    default: "moderate"
  },
  pros: {
    type: [String],
...
orthodonticCaseSchema.index({
  ...
  partialFilterExpression: {
    status: {
      $in: ["draft", "diagnosis", "treatment_planning", "active"]
    }
  }
});
