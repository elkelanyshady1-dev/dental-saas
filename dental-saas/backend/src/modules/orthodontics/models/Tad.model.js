...
const TadSchema = new mongoose.Schema({
  ...
  position: {
    type: String,
    enum: ["interradicular", "infrazygomatic_crest", "buccal_shelf", "palatal", "symphysis", "retromolar", "apical", "other"],
    required: true
  },
  positionLabel: {
    type: String
  },
  // e.g. "Interradicular 14-15"
