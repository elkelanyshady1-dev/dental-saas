...
// ─── Indexes ────────────────────────────────────────────────────────────────
reviewCommentSchema.index({ reviewStageId: 1, createdAt: 1 });
reviewCommentSchema.index({ caseId: 1, createdAt: 1 });
reviewCommentSchema.index({ authorId: 1, authorType: 1 });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, reviewCommentSchema),
};
