...
// ─── Indexes ────────────────────────────────────────────────────────────────
reviewStageSchema.index({ caseId: 1, stageType: 1 });
reviewStageSchema.index({ caseId: 1, status: 1 });
reviewStageSchema.index({ reviewedBy: 1, status: 1 });
reviewStageSchema.index({ requestedBy: 1, status: 1 });
reviewStageSchema.index({ organizationId: 1, status: 1 });
