...
// ─── Indexes ─────────────────────────────────────────────────────────────────
monitoringSessionSchema.index({ organizationId: 1, patientId: 1, caseId: 1 });
monitoringSessionSchema.index({ organizationId: 1, status: 1, createdAt: -1 });
monitoringSessionSchema.index({ organizationId: 1, alignerProgressId: 1 });
monitoringSessionSchema.index({ organizationId: 1, reviewedBy: 1 });
