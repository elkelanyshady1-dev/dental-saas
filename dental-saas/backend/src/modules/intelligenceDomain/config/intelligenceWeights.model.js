...
const intelligenceWeightsSchema = new mongoose.Schema({
    ...
    revenueWeight: { type: Number, default: 0.30 },
    marginWeight: { type: Number, default: 0.25 },
    efficiencyWeight: { type: Number, default: 0.20 },
    completionWeight: { type: Number, default: 0.15 },
    reliabilityWeight: { type: Number, default: 0.10 }
}, { timestamps: true });
