...
const patientUserSchema = new mongoose.Schema(
    {
        ...
        portalPermissions: {
            ...
            canCancelAppointment: { type: Boolean, default: true },
...
patientUserSchema.index({ email: 1 }, { unique: true });
patientUserSchema.index({ patientId: 1 }, { unique: true });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, patientUserSchema),
};
