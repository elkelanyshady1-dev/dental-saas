...
const {
  applyCoupon
} = require("@core/billing/couponResolver");
const {
  applyCampaigns
} = require("@core/billing/campaignResolver");
...
async function generateBillingInvoice(organizationId, couponCode = null) {
  ...
  let taxPercent = 0;
  if (org.billingCountry === "AE") taxPercent = 5;else if (org.billingCountry === "SA") taxPercent = 15;
  ...
  eventBus.emit("invoice.created.v1", {
