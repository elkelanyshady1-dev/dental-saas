...
const alignerProductionCaseSchema = new mongoose.Schema(
    {
        ...
        requestingDoctorName: { type: String, required: true },
        requestingDoctorClinic: { type: String },
        requestingDoctorPhone: { type: String },
        requestingDoctorEmail: { type: String },

        patientAlias: { type: String }, // Anonymized label for lab privacy
        ...
        threeShapeProjectId: { type: String },
        simulationVideoUrl: { type: String },

        treatmentTimeline: [
            {
                stageNumber: { type: Number },
                plannedMovement: { type: String },
...
alignerProductionCaseSchema.index({ organizationId: 1 });
