...
orthoTodoSchema.index({ caseId: 1, status: 1, createdAt: -1 });

// Pending todos for a patient
orthoTodoSchema.index({ patientId: 1, status: 1 });

// Tenant-scoped
orthoTodoSchema.index({ organizationId: 1, caseId: 1 });

// Visit-scoped
orthoTodoSchema.index({ visitId: 1 });
