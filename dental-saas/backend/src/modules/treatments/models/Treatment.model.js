...
treatmentSchema.index({ branchId: 1, status: 1 });
treatmentSchema.index({ appointmentId: 1 });
treatmentSchema.index({ procedureId: 1 });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, treatmentSchema),
};
