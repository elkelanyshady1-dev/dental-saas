...
const { extractOrgId, assertOrgContext } = require("@core/security/assertOrgContext");
const { enforceDTO } = require("./utils/enforceDTO");
const { mapTicket, mapTicketDetail } = require("./utils/transformers");
...
async function getTicketDetail(req, ticketId) {
    const ticket = await Ticket
        ...
        .select("-internalNotes -linkedInvoiceId -linkedSubscriptionId -linkedMutationId -providerDisputeId -financialImpactMinor -escalationLevel -breachFlag")
        .lean();
