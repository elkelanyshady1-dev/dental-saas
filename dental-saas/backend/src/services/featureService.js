...
async function computeOrgFeatures(org) {
    ...
    if (org.features) {
        const entries = typeof org.features.entries === "function"
            ? [...org.features.entries()]
...
exports.isFeatureEnabled = (org, featureKey) => {
    ...
    const entry = typeof org.features.get === "function"
        ? org.features.get(featureKey)
        : org.features[featureKey];
