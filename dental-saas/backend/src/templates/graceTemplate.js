module.exports = function graceTemplate(org, gracePeriodEnd) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
        ...
        <div style="background-color: #fef3c7; border: 1px solid #fde68a; padding: 15px; border-radius: 8px; margin: 20px 0;">
            <p style="margin: 0; font-weight: bold;">Grace Period Ends On: ${new Date(gracePeriodEnd).toLocaleDateString()}</p>
        </div>
