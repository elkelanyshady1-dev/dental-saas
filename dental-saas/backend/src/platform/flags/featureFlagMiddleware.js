...
const FeatureFlag = require("../billing/models/FeatureFlag.model").default;
...
async function resolveFeatureFlags(req, res, next) {
    ...
    try {
        ...
        if (process.env.NODE_ENV !== "production") {
            logger.debug(
                { orgId, flagCount: Object.keys(resolved).length, flags: resolved },
