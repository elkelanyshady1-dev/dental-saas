...
guardianAuditSchema.index({ createdAt: -1 });

// Partial index for recent critical-only queries
guardianAuditSchema.index({ "summary.critical": 1, createdAt: -1 });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, guardianAuditSchema),
};
