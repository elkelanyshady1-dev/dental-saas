...
exports.overrideOrganizationFeature = async (req, res) => {
    try {
        ...
        if (resetOverride) {
            const current = org.features[key] || { enabled: featureDef.defaultEnabled, overridden: false };
            org.features[key] = { ...current, overridden: false };
        } else {
            org.features[key] = { enabled, overridden: true };
        }
