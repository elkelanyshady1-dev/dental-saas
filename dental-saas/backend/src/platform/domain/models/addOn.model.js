...
const addOnSchema = new mongoose.Schema({
    ...
    code: { type: String, required: true }, // e.g. "EXTRA_SMS_1000", "EXTRA_USERS_5"
    ...
    benefits: { type: mongoose.Schema.Types.Mixed, required: true },
...
addOnSchema.index({ code: 1 }, { unique: true });
...
module.exports = {
    modelName,
    schema: addOnSchema,
    default: mongoose.models[modelName] || mongoose.model(modelName, addOnSchema),
};
