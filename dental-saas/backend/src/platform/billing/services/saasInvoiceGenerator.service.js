/**
 * saasInvoiceGenerator.service.js
 * Phase v5-6 — Platform SaaS Invoice Generation
 *
 * Generates draft invoices for org billing cycles (platform plane).
 * Called by internal cron/webhook handlers without HTTP req context.
 *
 * PLANE: Platform (moved from billingDomain/organizationFinance — Phase 4 separation)
 */

"use strict";

const BillingInvoice = require("../models/PlatformInvoice.model");
