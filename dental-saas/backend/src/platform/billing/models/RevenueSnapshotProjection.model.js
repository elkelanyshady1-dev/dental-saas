...
revenueSnapshotProjectionSchema.index({ totalRevenueMinor: -1 });
revenueSnapshotProjectionSchema.index({ organizationId: 1 }, { unique: true });

// Geopolitical Sovereignty Indexes (v13.0)
revenueSnapshotProjectionSchema.index({ regionCode: 1, snapshotDate: 1 });
revenueSnapshotProjectionSchema.index({ regionCode: 1, organizationId: 1 });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, revenueSnapshotProjectionSchema),
};
