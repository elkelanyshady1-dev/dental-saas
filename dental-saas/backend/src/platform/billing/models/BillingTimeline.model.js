...
const billingTimelineSchema = new mongoose.Schema({
  ...
  eventType: {
    type: String,
    required: true,
    enum: ["TRIAL_STARTED", "TRIAL_ENDED", "CONTRACT_ACTIVATED", "CONTRACT_CANCELLED", "INVOICE_CREATED", "PAYMENT_SUCCEEDED", "PAYMENT_FAILED", "RENEWAL_COMPLETED", "UPGRADE_APPLIED", "DOWNGRADE_SCHEDULED", "REFUND_COMPLETED",
