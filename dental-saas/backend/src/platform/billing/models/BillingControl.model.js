...
const billingControlSchema = new mongoose.Schema(
    {
        ...
        // ── Kill Switch State ─────────────────────────────────────────────────
        killSwitch: { type: Boolean, default: false, required: true },
...
billingControlSchema.index(
    { singleton: 1 },
    { unique: true, name: "unique_billing_control_singleton" }
);
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, billingControlHistorySchema),
};
