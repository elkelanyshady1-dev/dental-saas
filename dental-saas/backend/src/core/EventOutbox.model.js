...
eventOutboxSchema.index({ status: 1 });
// Cleanup / archival: published events older than N days
eventOutboxSchema.index({ status: 1, publishedAt: 1 });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, eventOutboxSchema),
};
