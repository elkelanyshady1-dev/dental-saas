...
verificationTokenSchema.index({ identifier: 1, purpose: 1, isUsed: 1, createdAt: -1 });

// Rate limiting query: count recent tokens per identifier + purpose
verificationTokenSchema.index({ identifier: 1, purpose: 1, createdAt: -1 });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, verificationTokenSchema),
};
