...
stripeEventSchema.index({ correlationId: 1 });
stripeEventSchema.index({ processedAt: 1 }, { expires: "30d" });
...
module.exports = {
    ...
    default: mongoose.models[modelName] || mongoose.model(modelName, stripeEventSchema),
};
