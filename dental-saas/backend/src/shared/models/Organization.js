...
const organizationSchema = new mongoose.Schema({
  ...
  regionCode: {
    ...
    default: null,
    immutable: false,
    // Must allow initial set after creation
    uppercase: true
  },
  ...
  migrationState: {
    type: String,
    enum: [null, "PREPARING", "SYNCING", "CUTOVER_PENDING", "CUTOVER", "VERIFYING", "COMPLETE", "FAILED"],
    default: null
  },
