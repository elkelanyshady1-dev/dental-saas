...
const appointmentSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ["open", "confirmed", "checked-in", "in-progress", "completed", "delayed", "postponed", "cancelled", "no-show", "waiting-list"],
    default: "open"
  },
  ...
  treatment: {
    ...
    // minutes — may differ from appointment.duration if overridden
    color: {
      type: String
    }
  },
