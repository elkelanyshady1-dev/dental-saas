    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tr>
                ...
                <td style="padding: 10px; border-bottom: 1px solid #ddd; text-transform: capitalize;">${snap.plan}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 10px; border-bottom: 1px solid #ddd;">$${snap.basePrice}</td>
            </tr>
            <tr>
                <td style="padding: 10px; border-bottom: 1px solid #ddd;"><strong>Inflation Applied:</strong></td>
                <td style="padding: 10px; border-bottom: 1px solid #ddd;">+$${snap.inflationApplied}</td>
            </tr>
            <tr>
                <td style="padding: 10px; border-bottom: 1px solid #ddd;"><strong>Coupon Discount:</strong></td>
                <td style="padding: 10px; border-bottom: 1px solid #ddd;">-$${snap.couponDiscount}</td>
            </tr>
            <tr>
                <td style="padding: 10px; font-weight: bold; font-size: 1.2em;">Total Amount:</td>
                <td style="padding: 10px; font-weight: bold; font-size: 1.2em;">$${snap.finalAmount} ${snap.currencyAtBilling || "USD"}</td>
            </tr>
            <tr>
