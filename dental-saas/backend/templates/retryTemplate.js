    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <tr>
                ...
                <td style="padding: 10px; border-bottom: 1px solid #ddd;">$${invoice.subscriptionSnapshot.finalAmount}</td>
            </tr>
            <tr>
        ...
        ${isExhausted
            ? `<div style="background-color: #fee2e2; border: 1px solid #fecaca; padding: 15px; border-radius: 8px; margin: 20px 0;">
               ...
               <p>Your account will be suspended if payment is not received before your grace period expires (${new Date(org.subscription.graceEndsAt).toLocaleDateString()}).</p>`
