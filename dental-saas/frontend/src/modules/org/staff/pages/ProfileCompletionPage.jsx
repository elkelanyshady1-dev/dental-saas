/**
 * ProfileCompletionPage.jsx — Staff Profile Completion Gate
 * Phase 4 — Blocking page shown when profile.isComplete === false.
 *
 * Route: /complete-profile (outside OrgLayout — no sidebar).
 * On success → navigate to /org/dashboard.
 *
 * Cursor Rules §9: useMutation for the update, no manual fetch.
 */
...
export default function ProfileCompletionPage() {
    ...
    const fieldClass = (key) =>
        `w-full h-12 rounded-xl border px-4 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${fieldErrors[key] ? "border-red-400 bg-red-50" : "border-gray-200"}`;
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-violet-600 shadow-xl shadow-blue-600/30 mb-4">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Welcome to {user?.orgName || "the clinic"}! Set up your profile to continue.
                    </p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5" id="complete-profile-form">
                        ...
                        <button
                            ...
                            type="submit"
                            disabled={isPending}
                            className="w-full h-12 rounded-xl bg-gradient-to-r from-blue-600 to-violet-600 text-white text-sm font-semibold hover:from-blue-700 hover:to-violet-700 shadow-lg shadow-blue-600/25 transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-2"
                        >
                            {isPending ? (
                ...
                <p className="text-center text-xs text-gray-400 mt-4">
                    This information is only visible to your organization administrators.
                </p>
            </div>
        </div>
    );
