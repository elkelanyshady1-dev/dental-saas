...
/* ═══════════════════════════════════════════════════════════════
   ExtraoralUploadModal — Modal grid for uploading extraoral photos.
   Extracted from OrthoRecordsTab (lines 3069–3151) without logic changes.
   ═══════════════════════════════════════════════════════════════ */

export interface ExtraoralUploadModalProps {
  isOpen: boolean;
  onClose: () => void;
  records: PhotoRecord[];
...
const ExtraoralUploadModal: React.FC<ExtraoralUploadModalProps> = ({
  isOpen,
  onClose,
  records,
  getAspectRatioClass,
...
export default ExtraoralUploadModal;
